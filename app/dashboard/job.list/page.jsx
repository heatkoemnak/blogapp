...
import DeleteJobPopUp from '@/app/components/ui/Reusable/DeleteJobPopUp';
...
const JobPage = () => {
  ...
  try {
    ...
    mutate(`/api/jobs/user/${session?.user?.email}`); // re-fetch updated job list
  } catch (error) {
              ...
              <div className="flex items-center mt-4 px-4 justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4">
                        <div className="relative flex items-center gap-2">
                          <button
                            ...
                            type="button"
                          >
                              <Link href="/dashboard/job.create" className="flex gap-1 items-center">
            ...
            >
              ...
              <td className="px-6 py-4">
                <div className="flex justify-center items-center gap-4">
                  <Link
                    href={`/dashboard/job.list/view/${job.id}`}
                  ...
                  <Link
                    href={`/dashboard/job.update/${job.id}`}
                    className="font-medium text-teal-400 hover:underline"
                  >
                    Edit
                  </Link>
