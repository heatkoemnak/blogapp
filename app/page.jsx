...
export default function Home() {
  ...
  <img class="absolute top-0 right-0 mt-10 mr-10" src="saturn-assets/images/headers/light-orange-blue-1.png" alt=""/>
  <img class="absolute top-0 right-0 mt-64 sm:mt-80 lg:mt-64 w-2/5 animate-moveHand" src="saturn-assets/images/headers/robot-hand-header.png" alt=""/>
    ...
    <div class="container px-4 mx-auto">
      <div class="flex items-center">
        ...
        <div class="lg:hidden ml-auto">
          <button class="flex w-12 h-12 items-center justify-center bg-gray-100 hover:bg-gray-200 rounded-md transition duration-200">
        ...
        <ul class="hidden lg:flex ml-14 lg:w-auto lg:space-x-12">
          <li class="group relative">
            ...
            <div class="hidden group-hover:block absolute top-full left-0 min-w-max max-w-xs p-4 z-30">
  ...
  <div class="relative container px-4 mx-auto">
    <div class="max-w-xl xl:max-w-4xl">
      ...
      <div class="md:flex mb-14 max-w-xs sm:max-w-sm md:max-w-none">
        ...
        <div class="max-w-md">
        <p class="md:text-xl text-gray-900 font-semibold">Saturn is a startup {`that's`} making the world a better place! {`We've`} been working on our mission since 2025</p>
        </div>
      </div>
      ...
      <div class="max-w-2xl mb-20 lg:mb-0 lg:mr-32">
        ...
        <div class="flex items-center -mx-4">
          <div class="w-1/3 px-4">
            <img class="block" src="saturn-assets/logos/brands/logo-example3.png" alt=""/>
          </div>
          <div class="w-1/3 px-4">
            <img class="block" src="saturn-assets/logos/brands/logo-example2.png" alt=""/>
          </div>
          <div class="w-1/3 px-4">
            <img class="block" src="saturn-assets/logos/brands/logo-example1.png" alt=""/>
          </div>
        </div>
      </div>
