              ...
              {Steps.map((step, index) => (
                <Step key={index} onClick={() => setActiveStep(index)}>
                  ...
                  <div className="absolute -bottom-10 w-max text-center">
                    <Typography
                      color={activeStep === index ? 'orange' : 'gray'}
            ...
            <div className="flex items-center">
              <Menu as="div" className="relative inline-block text-left">
                <div className="flex gap-2 justify-between">
                  ...
                  <Button
                    onClick={handleNext}
                    disabled={isLastStep || title === '' || description === ''}
                  >
                    Next
                  </Button>
                </div>
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div className="ml-5 lg:col-span-3">
                ...
                <input
                  className="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-xl py-3 px-3 leading-tight focus:outline-none focus:border-[#253cd1]"
                  type="text"
                  placeholder="Title"
                  value={title}
