      ...
      {categoryList ? (
        categoryList.map((category) => (
          ...
          >
            <button
              type="button"
              class="bg-[#212121] border border-white hover:border-gray-200 dark:border-gray-900 dark:bg-gray-900 dark:hover:border-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 rounded-full text-sm font-medium px-3 py-2 text-center me-3 mb-3 dark:text-white dark:focus:ring-gray-800"
            >
             # {category.name}
            </button>
            {/* <button
