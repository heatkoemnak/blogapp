...
const Post = ({ post }) => {
  ...
  return (
    ...
    //     {/* Post Image */}
    //     <div className="lg:hidden flex justify-between mt-2 gap-2 items-center mb-2 ml-2">
    ...
    //         {post.title}
    //       </h1>
    //       <small className="bg-orange-500 text-white px-2 py-1">
    //         #{post?.category?.name}
    //       </small>
    //       <p className=" font-light text-gray-700 lg:mb-8 md:text-lg lg:text-xl ">
    //         {isExpanded ? post.body : post.body.substring(0, 200)}
    //         <br />
    //         <span>
    //           {post?.links.length > 0 &&
    ...
    <Link key={post?.id} href={`/blogs/${post?.id}`}>
      <div class="relative flex flex-col my-3 bg-white shadow-sm border border-slate-200 rounded-lg">
        ...
        <div class="flex items-center justify-between p-4">
          <div class="flex items-center">
            ...
            <div class="flex flex-col ml-3 text-sm">
              ...
              <span class="text-slate-600"> {post?.publishedAt}</span>
            </div>
          </div>
