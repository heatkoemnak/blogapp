...
const ErrorHandlerMessage = ({ errorMessage }) => {
  return (
    <div classNameName="fixed top-0 right-0 left-0 bottom-0 z-50 bg-blue-gray-50 dark:bg-gray-800 rounded-xl shadow-lg flex flex-col items-center justify-center">
      <div
      ...
      >
        ...
        <div className="mt-2 mb-4 text-sm">{errorMessage}</div>
