  ...
  return (
    <>
        ...
        <div class="relative">
          <div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8 ">
            <div class="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0 ">
              <div>
                <div>
                  <span class="flex h-12 w-12 items-center justify-center rounded-xl bg-[#ff0]">
                    <svg
      ...
      {/* <div class="grid grid-cols-1 lg:grid-cols-3 items-center border border-neutral-700 divide-y lg:divide-y-0 lg:divide-x divide-neutral-700 rounded-xl">
        <a
          class="group relative z-10 p-4 md:p-6 h-full flex flex-col bg-gradient-to-r from-red-400 to-purple-500 focus:outline-none first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none before:absolute before:inset-0 before:bg-gradient-to-b before:hover:from-transparent before:hover:via-transparent before:hover:to-[#ff0]/10 before:via-80% before:focus:from-transparent before:focus:via-transparent before:focus:to-[#ff0]/10 before:-z-[1] before:last:rounded-b-xl lg:before:first:rounded-s-xl lg:before:last:rounded-e-xl lg:before:last:rounded-bl-none before:opacity-0 before:hover:opacity-100 before:focus:opacity-100"
          href="#"
        >
          <div class="mb-5">
            <svg
            ...
            <div class="mt-5">
              <p class="font-semibold text-5xl text-gray-800">Blog content</p>
        ...
        >
          <div class="mb-5">
            ...
            <div class="mt-5">
              <p class="font-semibold text-5xl text-gray-800">Build Portfolio</p>
              <h3 class="mt-5 font-medium text-lg text-gray-800">
                Rise in E-commerce
              </h3>
              <p class="mt-1 text-neutral-400">
        ...
        <a
          class="group relative z-10 p-4 md:p-6 h-full flex flex-col bg-gradient-to-r from-orange-400 to-purple-400 focus:outline-none first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none before:absolute before:inset-0 before:bg-gradient-to-b before:hover:from-transparent before:hover:via-transparent before:hover:to-[#ff0]/10 before:via-80% before:focus:from-transparent before:focus:via-transparent before:focus:to-[#ff0]/10 before:-z-[1] before:last:rounded-b-xl lg:before:first:rounded-s-xl lg:before:last:rounded-e-xl lg:before:last:rounded-bl-none before:opacity-0 before:hover:opacity-100 before:focus:opacity-100"
          href="#"
        >
          <div class="mb-5">
            <svg
            ...
            <div class="mt-5">
              <p class="font-semibold text-5xl text-gray-800">Event planing</p>
              <h3 class="mt-5 font-medium text-lg text-gray-800">
